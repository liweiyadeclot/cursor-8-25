...
这个文件包含了所有必要的代码，可以直接复制到 Dify 代码节点中使用
不需要导入任何外部模块（除了 openpyxl，Dify 应该已安装）
"""

# ============================================================================
# 在 Dify 代码节点中，直接复制以下代码
# ============================================================================
...
# ============================================================================
# 2. MCP 提示词生成函数（简化内联版本）
# ============================================================================

def build_playwright_prompt_inline(json_data):
    """
    从 JSON 数据生成 Playwright MCP 提示词（简化内联版本）
    """
    segments = []
